...
(* Lemma infer_f_bind_fail_f (e : exp) t f n : *)
(*   not_bound_in n t -> *)
(*   infer_f f (tree_bind t (fun x => if e x then Leaf x else Fail St n)) == *)
(*   infer_f (fun x => if e x then f x else 0) t. *)
(* Proof. *)
(*   unfold tree_bind. *)
